...
asteroide_destruido_esq:
    ...
    CALL aumenta_energia ; jump para aumentar energia
termina_asteroide_esq:
    ...
    JMP inicia_asteroide ; recomeça o processo do asteroide
...
ciclo_esq:
    ...
    ADD R7, 1 ; aumenta a linha porque os asteroides descem
...
aumenta_energia:
    ...
    JNZ ret_aux ; retornar caso não for minerável
